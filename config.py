...
OUTPUT_REPORT = 'relatorio_analise_calibracao.md' # Usaremos Markdown para o relatório
...
OPTIMAL_K = 2                 # Número de clusters escolhido (baseado na sua análise)
...
print("Configurações carregadas.") # Mensagem para confirmar que o arquivo foi lido